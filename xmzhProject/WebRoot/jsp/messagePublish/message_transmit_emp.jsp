...
<h:form name="inputForm" id="inputForm"
	action="/messagePublish/tMessagePublishAction_saveTransmitEmp.action" method="post"
	...
	<h:hidden property="messageId" />
	<h:hidden property="status" />
	<h:hidden name="message.opninion" property="message.opninion"/>
	<table align="center" border="0" class="form_table" width="100%">
		<tr>
			...
			<td colspan="2"><h:hidden
				property="message.empId" id="empid" /> 
				<h:text property="message.empName" validateAttr="allowNull=false" id="empname"
				readonly="true" name="message.empName" /> <input type="button" value="选择" class="button"
