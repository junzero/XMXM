...
public interface ITProcessTaskAssigneePersonService {
    /**
     * 通过spring注入DAO的set类.
     * @abatorgenerated
     */
    void settProcessTaskAssigneePersonDAO(ITProcessTaskAssigneePersonDAO tProcessTaskAssigneePersonDAO) throws Exception;

    /**
     * 通过spring注入DAO的get类.
     * @abatorgenerated
     */
    ITProcessTaskAssigneePersonDAO gettProcessTaskAssigneePersonDAO() throws Exception;
     ...
     * @abatorgenerated
     */
    void update(TProcessTaskAssigneePerson obj) throws Exception;

    /**
     * 插入单条记录
     * @abatorgenerated
     */
    void insert(TProcessTaskAssigneePerson obj) throws Exception;

    /**
     * 删除单条记录
     * @abatorgenerated
     */
    void delete(TProcessTaskAssigneePerson obj) throws Exception;
