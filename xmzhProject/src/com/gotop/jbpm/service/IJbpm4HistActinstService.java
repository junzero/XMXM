...
public interface IJbpm4HistActinstService {
    /**
     * 通过spring注入DAO的set类.
     * @abatorgenerated
     */
    void setJbpm4HistActinstDAO(IJbpm4HistActinstDAO jbpm4HistActinstDAO) throws Exception;

    /**
     * 通过spring注入DAO的get类.
     * @abatorgenerated
     */
    IJbpm4HistActinstDAO getJbpm4HistActinstDAO() throws Exception;
     ...
     * @abatorgenerated
     */
    void update(Jbpm4HistActinst obj) throws Exception;

    /**
     * 插入单条记录
     * @abatorgenerated
     */
    void insert(Jbpm4HistActinst obj) throws Exception;

    /**
     * 删除单条记录
     * @abatorgenerated
     */
    void delete(Jbpm4HistActinst obj) throws Exception;
