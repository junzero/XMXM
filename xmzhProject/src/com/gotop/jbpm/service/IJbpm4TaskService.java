...
public interface IJbpm4TaskService {
    /**
     * 通过spring注入DAO的set类.
     * @abatorgenerated
     */
    void setJbpm4TaskDAO(IJbpm4TaskDAO jbpm4TaskDAO) throws Exception;

    /**
     * 通过spring注入DAO的get类.
     * @abatorgenerated
     */
    IJbpm4TaskDAO getJbpm4TaskDAO() throws Exception;
     ...
     * @abatorgenerated
     */
    void update(Jbpm4Task obj) throws Exception;

    /**
     * 插入单条记录
     * @abatorgenerated
     */
    void insert(Jbpm4Task obj) throws Exception;

    /**
     * 删除单条记录
     * @abatorgenerated
     */
    void delete(Jbpm4Task obj) throws Exception;
