...
public interface IJbpm4HistTaskService {
    /**
     * 通过spring注入DAO的set类.
     * @abatorgenerated
     */
    void setJbpm4HistTaskDAO(IJbpm4HistTaskDAO jbpm4HistTaskDAO) throws Exception;

    /**
     * 通过spring注入DAO的get类.
     * @abatorgenerated
     */
    IJbpm4HistTaskDAO getJbpm4HistTaskDAO() throws Exception;
     ...
     * @abatorgenerated
     */
    void update(Jbpm4HistTask obj) throws Exception;

    /**
     * 插入单条记录
     * @abatorgenerated
     */
    void insert(Jbpm4HistTask obj) throws Exception;

    /**
     * 删除单条记录
     * @abatorgenerated
     */
    void delete(Jbpm4HistTask obj) throws Exception;
