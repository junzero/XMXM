package com.gotop.dataUser.service;
...
public interface ITRangeUserService {
    /**
     * 通过spring注入DAO的set类.
     * @abatorgenerated
     */
    void settRangeUserDAO(ITRangeUserDAO tRangeUserDAO) throws Exception;

    /**
     * 通过spring注入DAO的get类.
     * @abatorgenerated
     */
    ITRangeUserDAO gettRangeUserDAO() throws Exception;
     ...
     * @abatorgenerated
     */
    void update(TRangeUser obj) throws Exception;

    /**
     * 插入单条记录
     * @abatorgenerated
     */
    void insert(TRangeUser obj) throws Exception;

    /**
     * 删除单条记录
     * @abatorgenerated
     */
    void delete(TRangeUser obj) throws Exception;
