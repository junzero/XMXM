...
public class AcApplication implements Serializable {
	private static final long serialVersionUID = -2873976845001204497L;
	...
	private String paraNameStr;
	private String from;//用于区分是否显示关闭按钮等
	...
	public String getParaNameStr() {
		return paraNameStr;
	}

	public void setParaNameStr(String paraNameStr) {
		this.paraNameStr = paraNameStr;
	}
