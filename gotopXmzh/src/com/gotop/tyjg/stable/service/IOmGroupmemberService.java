...
public interface IOmGroupmemberService {
    /**
     * 通过spring注入DAO的set类.
     * @abatorgenerated
     */
    void setOmGroupmemberDAO(IOmGroupmemberDAO omGroupmemberDAO) throws Exception;

    /**
     * 通过spring注入DAO的get类.
     * @abatorgenerated
     */
    IOmGroupmemberDAO getOmGroupmemberDAO() throws Exception;
     ...
     * @abatorgenerated
     */
    void update(OmGroupmemberKey obj) throws Exception;

    /**
     * 插入单条记录
     * @abatorgenerated
     */
    void insert(OmGroupmemberKey obj) throws Exception;

    /**
     * 删除单条记录
     * @abatorgenerated
     */
    void delete(OmGroupmemberKey obj) throws Exception;
