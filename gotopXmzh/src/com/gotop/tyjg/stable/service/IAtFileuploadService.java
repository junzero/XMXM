...
public interface IAtFileuploadService {
    /**
     * 通过spring注入DAO的set类.
     * @abatorgenerated
     */
    void setAtFileuploadDAO(IAtFileuploadDAO atFileuploadDAO) throws Exception;

    /**
     * 通过spring注入DAO的get类.
     * @abatorgenerated
     */
    IAtFileuploadDAO getAtFileuploadDAO() throws Exception;
     ...
     * @abatorgenerated
     */
    void update(AtFileupload obj) throws Exception;

    /**
     * 插入单条记录
     * @abatorgenerated
     */
    void insert(AtFileupload obj) throws Exception;

    /**
     * 删除单条记录
     * @abatorgenerated
     */
    void delete(AtFileupload obj) throws Exception;
