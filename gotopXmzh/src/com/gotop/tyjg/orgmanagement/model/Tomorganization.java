 ...
 * @version 1.0
 * 
 * HISTORY 2012-3-20 xuxh 创建文件
 * 
 * *******************************
 */
public class Tomorganization implements Serializable {
	
	private static final long serialVersionUID = 7231700210369684259L;
	...
	private String zxjjgid;
	
	public String getZxjjgid() {
		return zxjjgid;
	}

	public void setZxjjgid(String zxjjgid) {
		this.zxjjgid = zxjjgid;
	}
	...
	public String getOrgTypeField() {
		return orgTypeField;
	}

	public void setOrgTypeField(String orgTypeField) {
