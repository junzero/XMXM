...
if (typeof(SWFUpload) === "function") {
	...
	SWFUpload.prototype.cancelQueue = function () {
		...
		while (stats.files_queued > 0) {
			...
			document.getElementById(fileId+"_del").parentNode.innerHTML="<span id=\""+fileId+"_delFile\" swtId=\""+fileId+"\" onclick=\"__deleteTrFun(this,0)\" class=uploadCancel>删除</span>";
			document.getElementById(fileId).style.color="red";//add by stephen
			document.getElementById(fileId+"_bar").parentNode.innerHTML="<font style='color: red;'>已取消</font>";//add by stephen
			this.cancelUpload();
			stats = this.getStats();
		}
