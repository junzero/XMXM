/*
* 报刊零售ajax_common的过滤条件
* 
* 命名规则：BKLS + 包路径 + 具体的功能名称 
* （如：机构列表 -->  BKLS_COMMONS_JGLB_JG）
*/


/****************
 * 公共功能模块     “BKLS_COMMONS” 开头
 ****************/

	//-->公共逻辑构件 "COMMON" 开头
	
		//备注列表
		var  BKLS_COMMONS_COMMON_BZ = 0;
	...
	//-->机构管理逻辑构件 "JGGL" 开头	
		...
		//地市列表
		var BKLS_COMMONS_JGGL_DS = 1;
		
		//机构列表
		var BKLS_COMMONS_JGGL_JG  = 1;
		
		//省级列表
		var BKLS_COMMONS_JGGL_SJ = 1;

		//县级列表
		var BKLS_COMMONS_JGGL_XJ = 1;
		
		//支局机构列表
		var BKLS_COMMONS_JGGL_ZJJG = 1;
