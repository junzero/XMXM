...
document.write('<select id="selTianYear" style="'+s_tiannet_select+'" Author="tiannet"  '+
    ' onChange="tiannetYear=this.value;tiannetSetDay(tiannetYear,tiannetMonth);document.getElementById("tiannetYearHead").style.display=\'\';'+
...
document.write('<select id="selTianMonth" style="'+s_tiannet_select2+'" Author="tiannet" '+
    'onChange="tiannetMonth=this.value;tiannetSetDay(tiannetYear,tiannetMonth);document.getElementById("tiannetMonthHead").style.display=\'\';'+
    'this.style.display=\'none\';">');
for(var i=1;i <= 12;i ++){
...
function tiannetWriteHead(){
 document.getElementById("tiannetYearHead").innerText = tiannetYear + "年";
 document.getElementById("tiannetMonthHead").innerText = tiannetMonth + "月";
 if( m_bolShowHour )  document.getElementById("tiannetHourHead").innerText = " "+tiannetHour + "时";
 if( m_bolShowMinute ) document.getElementById("tiannetMinuteHead").innerText = tiannetMinute + "分";
...
function tiannetHideObject(strTagName) {
 ...
 var stn = document.getElementsByTagName(strTagName);
