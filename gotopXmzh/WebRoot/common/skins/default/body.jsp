...
//	}
	...
	function callBack(value){
		...
		if(value){
			...
			menuFrame.contentWindow.$id("orgname").innerHTML="["+valueArra[1]+"]";
			
			orgid = valueArra[0];
			
			$id("cell1").queryAction = "org.gocom.abframe.tools.OperlogManager.queryAbfTGgb.biz";
			$id("cell1").dataXML = null;
			$id("cell1").loadData();
			$id("cell1").refresh();
...
<%--		<w:panel id="dbsy" width="100%" title="公告信息">
		...
		<w:panel id="dbsy" width="100%" title="公告信息">
			<r:datacell entityType="com.primeton.purview.tools.AbfTDbsyb"  height="170" id="cell1" width="800" xpath="abftggb" queryAction="org.gocom.abframe.tools.OperlogManager.queryAbfTGgb.biz"  initParamFunc="abfTDbsybFun">
		...
		<w:panel id="ggxx" width="100%" title="待办事宜">
			<r:datacell entityType="com.primeton.purview.tools.AbfTDbsyb" height="230" id="cell2" queryAction="org.gocom.abframe.tools.OperlogManager.queryAbfTDbsyb.biz" width="800" xpath="abfTdbsyb">
			  <r:toolbar location="bottom" tools="nav,pagesize,info"/>
...
//		return "<input style='margin-top:-4' type='button' class='button' value='查看' onclick=dbsyButtion('"+entity.getProperty("iDbsybh")+"') />";
    ...
    function abfTDbsybFun(){
    	return "<hm><jgbh>"+orgid+"</jgbh></hm>";
    }
</script>
</body>
</html>