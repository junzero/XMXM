...
//	      frm.submit();
	    ...
	    */
	    function getFormParam(dCell){
			...
			B += "<param><key>queryDatacellToPrint</key><value>true</value></param>";
											 ...
											 <table border="0" cellpadding="0" cellspacing="0">
													...
													<tr>
													 ...
													 <td id="sourceDatasTD" style="" align="center" valign="middle">
														 <select id="Source" name="Source" multiple="true" size="10" class="" style="width:150px;height: 260px" ondblclick="Add(document.all.Source,document.all.Target,1)">
														 <select>
													 </td>
													 <td valign="middle" align="center">
														<p style="width:100%" align="center">
															<input type="button" style="width: 20" class='button' value="->" onClick="Add(document.all.Source,document.all.Target,1)" title="添加">
														</p>
														<p style="width:100%" align="center">
															<input type="button" style="width: 20" class='button'value=">>" onClick="AddAll(document.all.Source,document.all.Target,1)" title="添加全部">
														</p>
														<p style="width:100%" align="center">
															<input type="button" style="width: 20" class='button'value="<-" onClick="Add(document.all.Target,document.all.Source,2)" title="删除">
														</p>
														<p style="width:100%" align="center">
															<input type="button" style="width: 20" class='button'value="<<" onClick="AddAll(document.all.Target,document.all.Source,2)" title="删除全部">
														</p>
													</td>
													<td align="center"  valign="top">
														<select id="Target" name="Target" multiple="multiple" size="10" style="width:150px;height: 260px" ondblclick="Add(document.all.Target, document.all.Source,2)">
														</select>
													</td>
