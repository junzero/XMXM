		...
		*/
	    function exportOrgs() {
		  ...
		  $id("fields").value = fields;
			...
			if (reInfo == "") {
				frm.action = "com.primeton.purview.importExcel.flowx";
				frm.target = "querylistFrame";
//				$id('_eosFlowAction').value = "importExcel";
				frm.elements["_eosFlowAction"].value = "importExcel";
				frm.submit();
			} else {
				alert(reInfo);
			}
	    ...
	    **/
		...
		function previewClick(){
			...
			var reInfo = checkSubmitCondition();
			if (reInfo == "") {
				formObj.action = "com.primeton.purview.importExcel.flowx";
...
<body>
<h:form name="submitForm" id="submitForm" action="com.primeton.purview.exportExcel.flowx" method="post" enctype="multipart/form-data">
	<table height="300" width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
		<tr>
				...
				<table width="95%"  border="1" align="center" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td align="center" valign="top">
							<input type="file" name="readFile" id="readFile" size="60">
						</td>
					</tr>
					<tr>
								...
								<tr>
									<td align="center">
										 <table border="0" style="" bordercolor="#111111" cellpadding="1" cellspacing="2">
											<tr height="20">
												 <td width="50"></td>
												 <td width="150">列表字段列表</td>
												 <td width="50"></td>
												 <td width="150">导入字段列表</td>
												 <td width="50"></td>
											</tr>
											<tr>
												 <td width="50"></td>
												 <td id="sourceDatasTD" style="" align="center" valign="middle">
													 <select id="Source" name="Source" multiple="true" size="10" style="width:150px;height: 200px" ondblclick="Add(document.getElementById('Source'),document.getElementById('Target'),1)">
													 <select>
												 </td>
												 <td valign="middle" align="center">
													<p style="width:100%" align="center">
														<input type="button" value="->" onClick="Add(document.getElementById('Source'),document.getElementById('Target'),1)" title="添加">
													</p>
													<p style="width:100%" align="center">
														<input type="button" value=">>" onClick="AddAll(document.getElementById('Source'),document.getElementById('Target'),1)" title="添加全部">
													</p>
													<p style="width:100%" align="center">
														<input type="button" value="<-" onClick="Add(document.getElementById('Target'),document.getElementById('Source'),2)" title="删除">
													</p>
													<p style="width:100%" align="center">
														<input type="button" value="<<" onClick="AddAll(document.getElementById('Target'),document.getElementById('Source'),2)" title="删除全部">
													</p>
												</td>
												<td align="center">
													<select id="Target" name="Target" multiple="multiple" size="10" style="width:150px;height: 200px" ondblclick="Add(document.getElementById('Target'), document.getElementById('Source'),2)">
													</select>
												</td>
					...
					<tr align="center">
						<td valign="middle" align="center" colspan="2">
							<input style="width:55" name='btok' id='btok' type='button' class='button' value='预览' onClick="previewClick();">
							<input style="width:55" name='btok' id='btok' type='button' class='button' value='导 入' onClick="exportOrgs();">
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CECECE" align="center">
		<tr>
			<td align="center" valign="top">
				 <table border="0" style="" bordercolor="#111111" cellpadding="1" cellspacing="2">
					<tr>
						<td width="700" height="240" id="tableHTML">
							导入预览
							<iframe width="99%" height="100%"  border="1" frameborder="NO" scrolling="NO" src="" name="querylistFrame">
							</iframe>
						</td>
					</tr>
				</table>
