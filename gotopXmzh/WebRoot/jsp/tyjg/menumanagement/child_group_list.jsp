...
<html>
  ...
  <body style="margin: 0px;">
    <e:datasource name="acFunctionGroup" type="bean" path="com.gotop.tyjg.menumanagement.model.AcFunctionGroup"/>
  	<h:form name="appFuncGroup_viewlist" action="/menumanagement/menuManagementAction_queryGroupChildGroupList.action" 
  		checkType="blur" target="_self" method="post">
  		<h:hidden id = "application_id" property = "acFunctionGroup.appId"/>
  		<h:hidden id = "funcGroupId" property = "acFunctionGroup.funcGroupId"/>
  		<h:hidden id = "groupLevel" property = "acFunctionGroup.groupLevel"/>
  		<h:hidden id = "funcGroupSeq" property = "acFunctionGroup.funcGroupSeq"/>
  		<h:hidden id = "groupid" property = "acFunctionGroup.parentGroup"/>
	    ...
	    <table align="center" border="0" width="100%" class="EOS_table">
	          ...
	          <tr class="<l:output evenOutput='EOS_table_row' oddOutput='EOS_table_row_o' />">
	            <td align="center">
	              <w:rowCheckbox>
	                ...
	                <h:param name='groupLevel' iterateId='id1' property='groupLevel'/>
	              </w:rowCheckbox>
	            </td>
	            <td>
	      ...
	      <tr>
	        <td colspan="6" class="command_sort_area">
	          <div class="h3">
	          <input type="button" class="button" value='新增功能组' onclick="addRecord();">
	          <l:greaterThan property="page.count" targetValue="0" compareType="number">
	            <input type="button" class="button"   value='修改功能组' 
	            		onclick="modiRecord();" id="updateButton">
	          </l:greaterThan>
	          <l:greaterThan property="page.count" targetValue="0" compareType="number">
	            <input type="button" class="button"   value='删除功能组'
	...
	<script type="text/javascript">
		...
		function addRecord(){
			...
			var groupLevel = $id('groupLevel').value;
			var funcGroupSeq = $id('funcGroupSeq').value;
			var groupid = $id('groupid').value;
			var url = "/jsp/tyjg/menumanagement/add_func_group.jsp";
		    url += "?appid="+appid+"&seq="+funcGroupSeq+"&groupid="+groupid+"&groupLevel="+(parseInt(groupLevel)+1);
	    ...
	    function checkSelectAll(){
	  	...
	  	function modiRecord(){
	  		...
	  		if(len == 0){
	  			...
	  			showModalCenter(encodeURI(strUrl), null, callBackFuncGroup, 500, 220, '修改功能组');
	  		}
	  	}
	  	function delRecord(){
	  		var gop = $id("group1");
