...
%>
  ...
  <e:datasource type="bean" name="acApplication" path="com.gotop.tyjg.menumanagement.model.AcApplication"/>
  	<h:form name="appAdd" action="/menumanagement/menuManagementAction_addApp.action" checkType="blur"  enctype="multipart/form-data" 
  ...
  <iframe width="0" height="0" name="result" style="display: none;"></iframe>
</h:form>
