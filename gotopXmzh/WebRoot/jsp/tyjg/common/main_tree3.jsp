...
<body topmargin="0" leftmargin="0" scroll="no">
	<table align="left" border="0" height="20" width="100%" style="vertical-align: top;">
		<tr valign="top">
			<td width="50%" valign="top" height="50" id="ss">
				<w:tabPanel id="tabs1" height="300">
...
function selectInitFun(){
	...
	if(modifySelfOrg){
		modifySelfOrg.src="/tree/initEmpPositionList_mainTree.action"+search;
