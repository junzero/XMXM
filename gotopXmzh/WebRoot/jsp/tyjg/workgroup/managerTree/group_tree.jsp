	...
	function lookupInit(){
		if(lookupTypeStr){
			...
			if(lookupTypeStr==3){
				...
				peArgument['Group']=[paramEntity,'groupname','groupid'];
			}
			if(lookupTypeStr==4){
		    	var paramEntity = new ParamEntity();
			...
			<tr valign="top">
				<td width="100%" valign="top">
					...
					<r:rtree id="orgSrcTree"  width="100%" height="370">
						<r:treeRoot childEntities="Group" display="群组树"
							initParamFunc="getInitParam" onDblclickFunc="rtnSelectVal"
							icon="/common/images/icons/arrow_merge.png"
							action="/tree/selectGroupTree_mainTree.action">
						</r:treeRoot>
						<r:treeNode nodeType="Group" showField="groupname"
							childEntities="Organization;Employee;oaRole" initParamFunc="getInitOrgParam"
							icon="/common/images/icons/chart_organisation.gif"
							submitXpath="group" onDblclickFunc="rtnSelectVal"
							action="/tree/selectGroupOrgEmpRole_mainTree.action">
							<r:treeMenu>
						  ...
						  <r:treeNode nodeType="Employee" onRefreshFunc="empListRefresh" showField="empname"
						  	 onDblclickFunc="rtnSelectVal" icon="/common/images/icons/user.gif" submitXpath="emp">
						  </r:treeNode>  
						  
						  <r:treeNode nodeType="Organization" showField="orgname" icon="/common/images/icons/building_link.png"
						    onDblclickFunc="rtnSelectVal" onRefreshFunc="orgListRefresh" submitXpath="org">
						  </r:treeNode>  
						  
						  <r:treeNode nodeType="oaRole" showField="rolename" icon="/common/images/icons/medal_bronze_1.png"
						    onDblclickFunc="rtnSelectVal" onRefreshFunc="roleListRefresh" submitXpath="org">
						  </r:treeNode>  
					</r:rtree>
				</td>
			</tr>
...
<script type="text/javascript">
	...
	*/
	...
	function getInitOrgParam(){
		var orgType = '${changeTre.orgType}';
		if(isBlank(orgType)){
			orgType = 3+4;
		}
		var ret = "<orgType>"+orgType+"</orgType>";
