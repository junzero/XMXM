			...
			<tr valign="top">
				<td width="100%" valign="top">
					<r:rtree id="orgTargetTree"  width="100%" height="375">
						<r:treeRoot childEntities="Organization;Employee" display="${changeTree.topName}"
							initParamFunc="tree2InitParam" onDblclickFunc="rtnSelectVal"
							icon="/common/images/icons/arrow_merge.png"
							action="/tree/selectBusessOrgEmp_mainTree.action">
						</r:treeRoot>
						<r:treeNode nodeType="Organization" showField="orgname" onDblclickFunc="rtnSelectVal"
							icon="/common/images/icons/chart_organisation.gif" initParamFunc="orgTree2InitParam" childEntities="Organization;Employee"
							submitXpath="oParentOrg" action="/tree/selectBusessOrgEmp_mainTree.action">
							<r:treeMenu>
