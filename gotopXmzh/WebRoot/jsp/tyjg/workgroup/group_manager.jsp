...
<table align="left" border="0" id="tableID" height="100%" width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td vAlign="top" width="25%">
   		<iframe name="groupTree" id="groupTree" align="top" scrolling="yes" 
   			src="/jsp/tyjg/workgroup/group_tree.jsp" style="width:100%" frameBorder=0>
		</iframe>		
    </td>
    <td vAlign="top" width="75%">
       <IFRAME  name="groupTabs" id="groupTabs" style="width:100%"  frameBorder="0"
	   		scrolling="auto" src="/jsp/tyjg/workgroup/group_tabs.jsp"></iframe> 
    </td>
  </tr>
</table>
