...
<%
	...
	String dicttypeid = request.getParameter("dictEntry.dicttypeid");
	String parentid = request.getParameter("dictEntry.parentid");
	request.setAttribute("dictEntry.dicttypeid", dicttypeid);
	request.setAttribute("dictEntry.parentid", parentid);
%>
<html>
<head>
...
<script language="javascript">
	...
	function saveDictEntry()
	{
	    ...
	    var myAjax = null;
	    var message;
		    myAjax = new Ajax("/tyjg/datadictionary/insertDictEntry_action.action");
        ...
        <h:hidden property="dictEntry.parentid"/>
 		<table align="center" border="1" width="296" class="form_table">
          ...
          <tr>
            ...
            <td colspan="1">
            	<h:text property="dictEntry.dictid" size="20" id="dictid" validateAttr="maxLength=128;allowNull=false;"/><font style="color:red">*</font>
            </td>
          </tr>
          <tr>
             <td class="form_label" align="left">
            ...
            <td colspan="1">
            	<h:text property="dictEntry.dictname" size="20" validateAttr="maxLength=255;allowNull=false;"/><font style="color:red">*</font>
            </td>
          </tr>
          <tr>
             <td class="form_label" align="left">
          ...
          <tr>
            ...
            <td colspan="1">
              	<h:select id="dictEntry.status" value="1" style="width=132" property="dictEntry.status">
