		...
		*/
	    function exportOrgs() {
		  ...
		  $id("fields").value = fields;
			...
			if (reInfo == "") {
				frm.action = "/tyjg/datadictionary/importExcel_action.action";
...
//				$id('_eosFlowAction').value = "importExcel";
	    ...
	    **/
		...
		function previewClick(){
			...
			var reInfo = checkSubmitCondition();
			if (reInfo == "") {
				formObj.action = "/tyjg/datadictionary/readFile_action.action";
...
<body>
<h:form name="submitForm" id="submitForm" action="/tyjg/datadictionary/readExprot_action.action" method="post" enctype="multipart/form-data">
