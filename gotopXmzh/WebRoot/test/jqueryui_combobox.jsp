...
<head>
	...
	<script src="../js/test/jquery.ui.core.js"></script>
	<script src="../js/test/jquery.ui.widget.js"></script>
	<script src="../js/test/jquery.ui.button.js"></script>
	<script src="../js/test/jquery.ui.position.js"></script>
	<script src="../js/test/jquery.ui.autocomplete.js"></script>
